...
@section('content')
<h2 style="color: #666; font-size: 2rem; margin-bottom: 10px;">Article Category Management</h2>
<div class="row" style="margin: 10px;">
    <div class="col-md-12" style="padding-right:0;">
        <table style="width:100%; border-collapse:collapse; font-size:15px;">
            ...
            <tbody>
                <!-- No article categories to display -->
            </tbody>
        </table>
        <div style="font-size:14px; color:#444; margin-top:8px;">Displaying 0 to 0 (of 0 article categories)</div>

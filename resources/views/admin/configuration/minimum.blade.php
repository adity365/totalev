...
@section('content')
<h2 style="color: #666; font-size: 2rem; margin-bottom: 10px;">Minimum Values</h2>
<div class="row" style="margin: 10px;">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:15px;">
            ...
            <tbody>
                <tr style="background:#f9f9f9;">
                    <td style="padding:8px; border:1px solid #ccc;">First Name</td>
                ...
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Last Name</td>
                ...
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Address Line1</td>
                ...
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Zip Code</td>
                    <td style="padding:8px; border:1px solid #ccc;">3</td>
                    <td style="padding:8px; border:1px solid #ccc; text-align:center;"><span style="font-size:18px; color:#444; cursor:pointer;">&#9432;</span></td>
                </tr>
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Credit Card Owner Name</td>
                    <td style="padding:8px; border:1px solid #ccc;">3</td>
                    <td style="padding:8px; border:1px solid #ccc; text-align:center;"><span style="font-size:18px; color:#444; cursor:pointer;">&#9432;</span></td>
                </tr>
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Credit Card Number</td>
    ...
    <div class="col-md-3" style="padding-left:0;">
        <div style="border:1px solid #ccc; background:#fff; margin-top:0;">
            <div style="background:#f2f2f2; font-weight:bold; padding:6px 10px; border-bottom:1px solid #ccc; font-size:15px;">First Name</div>
            <div style="padding:6px 10px;">
                <div style="margin-bottom:6px; color:#444; font-size:15px;">Minimum length of first name</div>
                ...
                <div style="font-size:15px; color:#444;">Date Added:Thu Dec 16, 2004<br>Date updated:Mon Jan 17, 2005</div>
            </div>
        </div>
    </div>
</div>

...
@section('content')
<h2 style="color: #666; font-size: 2rem; margin-bottom: 10px;">GZip Compression</h2>
<div class="row" style="margin: 10px;">
        ...
        <table style="width:100%; border-collapse:collapse; font-size:15px;">
            ...
            <tbody>
                <tr style="background:#f9f9f9;">
                    <td style="padding:8px; border:1px solid #ccc;">Enable GZip Compression</td>
                ...
                <tr>
                    <td style="padding:8px; border:1px solid #ccc;">Compression Level</td>
    ...
    <div class="col-md-3" style="padding-left:0;">
        <div style="border:1px solid #ccc; background:#fff; margin-top:0;">
            <div style="background:#f2f2f2; font-weight:bold; padding:6px 10px; border-bottom:1px solid #ccc; font-size:15px;">Enable GZip Compression</div>
            <div style="padding:6px 10px;">
                <div style="margin-bottom:6px; color:#444; font-size:15px;">Enable HTTP GZip compression.</div>
                ...
                <div style="font-size:15px; color:#444;">Date Added:Fri Dec 17, 2004<br>Date updated:Mon Aug 29, 2005</div>
            </div>
        </div>
    </div>
</div>

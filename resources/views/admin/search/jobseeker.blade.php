...
@section('content')
<h2 style="color: #666; font-size: 1.4rem; margin-bottom: 10px;">Search jobseekers</h2>
<div style="background:#fff; border:1px solid #ddd; border-radius:4px; padding:20px; max-width:900px; margin:0 0 0 10px;">
    <form>
        <div class="row mb-2">
            <div class="col-md-8">

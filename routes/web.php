...
use App\Http\Controllers\Auth\JobSeekerRegisterController;
...
// Admin Routes
Route::get('/my_admin', [LoginController::class, 'showLoginForm'])->name('login');
Route::post('/my_admin', [LoginController::class, 'login']);
Route::post('/my_admin/logout', [LoginController::class, 'logout'])->name('logout');

Route::middleware('auth')->group(function () {
    Route::get('/my_admin/dashboard', [DashboardController::class, 'index'])->name('admin.dashboard');
...
Route::post('register/jobseeker/resend-otp', [App\Http\Controllers\Auth\JobSeekerRegisterController::class, 'resendOTP'])->name('register.jobseeker.resend-otp');
Route::post('/jobseeker/update-personal-details', [App\Http\Controllers\Auth\JobSeekerRegisterController::class, 'updatePersonalDetails'])->name('jobseeker.updatePersonalDetails');
Route::post('/jobseeker/update-job-details', [App\Http\Controllers\Auth\JobSeekerRegisterController::class, 'updateJobDetails'])->name('jobseeker.updateJobDetails');
Route::get('/register/cities', [JobSeekerRegisterController::class, 'getCities']);
Route::get('/register/areas/', [JobSeekerRegisterController::class, 'getAreas']);
Route::get('/register/cities/search', [JobSeekerRegisterController::class, 'searchCities']);
Route::get('/register/areas/search', [JobSeekerRegisterController::class, 'searchAreas']);
Route::get('/register/area-details/{area_id}', [JobSeekerRegisterController::class, 'getAreaDetails']);

// Add this route for OTP verification and registration completion
Route::post('/register/verify', [JobSeekerRegisterController::class, 'verifyAndRegister'])->name('jobseeker.verify');
...
Route::get('register/company', [App\Http\Controllers\Auth\CompanyRegisterController::class, 'showRegistrationForm'])->name('register.company');
Route::post('register/company', [App\Http\Controllers\Auth\CompanyRegisterController::class, 'register'])->name('register.company.submit');
Route::post('register/company/send-otp', [App\Http\Controllers\Auth\CompanyRegisterController::class, 'sendOTP'])->name('register.company.send-otp');
Route::post('register/company/resend-otp', [App\Http\Controllers\Auth\CompanyRegisterController::class, 'resendOTP'])->name('register.company.resend-otp');
Route::post('/company/update-company-details', [App\Http\Controllers\Auth\CompanyRegisterController::class, 'updateCompanyDetails'])->name('company.updateCompanyDetails');

//Jobseeker Block
Route::get('/', [App\Http\Controllers\JobSeeker\JobSeekerController::class, 'index'])->name('home');
Route::get('/jobseekers', [App\Http\Controllers\JobSeeker\JobSeekerController::class, 'index'])->name('jobseekers.index');
